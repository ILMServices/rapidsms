...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'rapidsms_contact', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Contact.age'
        db.add_column(u'rapidsms_contact', 'age',
                      self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Contact.opted_in'
        db.add_column(u'rapidsms_contact', 'opted_in',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'rapidsms_contact', 'location')

        # Deleting field 'Contact.age'
        db.delete_column(u'rapidsms_contact', 'age')

        # Deleting field 'Contact.opted_in'
        db.delete_column(u'rapidsms_contact', 'opted_in')
    ...
    models = {
        ...
        u'rapidsms.contact': {
            ...
            'district': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.Location']", 'null': 'True', 'blank': 'True'}),
            ...
            'opted_in': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'contact'", 'unique': 'True', 'null': 'True', 'to': u"orm['auth.User']"}),
            'user_permissions': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.Permission']", 'symmetrical': 'False', 'blank': 'True'}),
            'village': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'villagers'", 'null': 'True', 'to': u"orm['locations.Location']"}),
