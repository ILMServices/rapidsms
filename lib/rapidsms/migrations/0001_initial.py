...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'rapidsms_contact_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contact', models.ForeignKey(orm[u'rapidsms.contact'], null=False)),
            ('permission', models.ForeignKey(orm[u'auth.permission'], null=False))
        ))
        db.create_unique(m2m_table_name, ['contact_id', 'permission_id'])

        # Adding M2M table for field groups on 'Contact'
        m2m_table_name = db.shorten_name(u'rapidsms_contact_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contact', models.ForeignKey(orm[u'rapidsms.contact'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'rapidsms_contact_user_permissions'))

        # Removing M2M table for field groups on 'Contact'
        db.delete_table(db.shorten_name(u'rapidsms_contact_groups'))
