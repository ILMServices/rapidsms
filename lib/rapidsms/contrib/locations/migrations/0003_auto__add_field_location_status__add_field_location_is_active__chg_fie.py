...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'locations_location', 'status',
                      self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.is_active'
        db.add_column(u'locations_location', 'is_active',
                      self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Location.code'
        db.alter_column(u'locations_location', 'code', self.gf('django.db.models.fields.CharField')(default=True, max_length=100))

    def backwards(self, orm):
        # Deleting field 'Location.status'
        db.delete_column(u'locations_location', 'status')

        # Deleting field 'Location.is_active'
        db.delete_column(u'locations_location', 'is_active')


        # Changing field 'Location.code'
        db.alter_column(u'locations_location', 'code', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
